...
const Legal = ({ lang = 'fr' }) => {
  ...
  const content = {
    fr: {
      ...
      hostDesc: "Le site est hébergé par GitHub Inc.",
      hostAddress: "Adresse : 88 Colin P. Kelly Jr. Street, San Francisco, CA 94107, États-Unis.",
      hostContact: "Contact hébergeur : +1 (877) 448-4820 https://github.com",
    ...
    en: {
      ...
      hostTitle: "2. Hosting",
      hostDesc: "This website is hosted by GitHub Inc.",
      hostAddress: "Address: 88 Colin P. Kelly Jr. Street, San Francisco, CA 94107, United States.",
      hostContact: "Host Contact: +1 (877) 448-4820 https://github.com",
